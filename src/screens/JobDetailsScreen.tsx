      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Section title="About the Role">
          <Text style={styles.paragraph}>
            We are looking for a creative Senior Product Designer to join our core
            team. You will work closely with engineering and product management to
        ...
        <Section title="Requirements">
          <Requirement text="5+ years of experience in product design or UX/UI roles." />
          <Requirement text="Strong portfolio showcasing user-centered design." />
          <Requirement text="Experience with Figma, Adobe Suite, prototyping tools." />
        </Section>

        {/* OFFICE LOCATION */}
        <Section title="Office Location">
          <View style={styles.mapBox}>
            <Text style={styles.mapText}>{company.location}</Text>
          </View>
        </Section>

        {/* NOTICE */}
        <View style={styles.notice}>
          <MaterialIcons name="info" size={22} color="#f97316" />
          <View style={{ marginLeft: 10 }}>
            <Text style={styles.noticeTitle}>Important Notice</Text>
            <Text style={styles.noticeText}>
              Please check details carefully. Applications cannot be edited after
              submission.
            </Text>
          </View>
        </View>
