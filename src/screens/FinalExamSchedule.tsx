...
// Sample Data - Final Exams (Different dates from mid-term)
...
const sampleLogs: LogEntry[] = [
  {
    ...
    message: 'Notification sent to 298 parents',
    status: 'success',
  },
  {
    id: '2',
    timestamp: 'Oct 28, 2023 - 09:16 AM',
    message: 'Failed to send to 8 contacts',
    status: 'failed',
  },
  {
    id: '3',
    timestamp: 'Oct 28, 2023 - 09:22 AM',
    message: 'Retry successful for 7 contacts',
    status: 'success',
  },
  {
    id: '4',
    timestamp: 'Oct 28, 2023 - 09:25 AM',
    message: 'Final exam schedule confirmation sent',
    status: 'success',
  },
];
...
const FinalExamSchedule = () => {
  ...
  const handleSaveReminder = () => {
    ...
    Alert.alert(
      'Reminder Saved',
      `Final exam reminder for ${selectedExam.subject} has been saved successfully!`,
      [
        {
...
>
  ...
  />
        ...
        <View style={styles.headerCenterContent}>
          ...
          <Text style={[styles.headerSubtitle, { color: colors.subText }]}>November 2023</Text>
        </View>
        <View style={styles.headerSpacer} />
      </View>
      ...
      >
        {/* Notification Info - Different styling for finals */}
        <View style={styles.section}>
          <Text style={[styles.sectionTitle, { color: colors.subText }]}>
            NOTIFICATION INFO
          </Text>
        ...
        {/* Invigilation Summary - More staff for finals */}
        <View style={styles.section}>
          <Text style={[styles.sectionTitle, { color: colors.subText }]}>
          ...
          <View style={[styles.card, { backgroundColor: colors.card, borderColor: colors.border }]}>
            <View style={styles.staffContainer}>
              <View style={styles.avatarGroup}>
                ...
                <View style={[styles.avatar, { backgroundColor: '#F87171', borderColor: colors.card }]}>
  ...
  const renderReminderScreen = () => (
    <SafeAreaView style={[styles.container, { backgroundColor: colors.surface }]}>
      ...
      >
            ...
            {selectedExam && (
              <View style={[styles.examInfo, { borderTopColor: colors.border }]}>
                ...
                <View style={styles.finalExamBadge}>
                  ...
                  <Text style={[styles.finalExamBadgeText, { color: '#8B5CF6' }]}>
                    Final Examination
                  </Text>
                </View>
              </View>
        ...
        {/* Info Box - Different message for finals */}
