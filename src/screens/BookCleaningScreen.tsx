...
// const [showEmployeeAllocation, setShowEmployeeAllocation] = useState(false);
...
//           <Text style={styles.cardTitle}>Allocation Type</Text>

//           <View style={{ paddingHorizontal: 16 }}>
//             <TouchableOpacity
//               style={styles.inputBox}
//            onPress={() => setShowEmployeeAllocation(true)}

//             >
//               <Text style={styles.label}>Allocation Type</Text>
//               <View style={styles.inputRow}>
//                 <Text style={styles.placeholder}>{allocationType}</Text>
//                 <MaterialIcons
...
//                 service: a.service,
//                 duration: a.duration,
//                 date: a.date ? formatDate(a.date) : "Same day",
//               })),
//               floorArea,
//               selectedTime,
...
//       {/* ALLOCATION MODAL */}
//       <Modal transparent animationType="slide" visible={allocationModal}>
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 140 }}>
        ...
        <View style={styles.jobCard}>
          ...
          <View style={{ paddingHorizontal: 16 }}>
            <TouchableOpacity
              style={styles.inputBox}
              onPress={() => setAllocationModal(true)}
            >
              <Text style={styles.label}>Allocation Type</Text>
              <View style={styles.inputRow}>
                <Text style={styles.placeholder}>{allocationType}</Text>
