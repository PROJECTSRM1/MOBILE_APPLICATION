...
import { ThemeProvider, useThemeMode } from "./src/screens/ThemeContext";
    ...
    <NavigationContainer theme={mode === "dark" ? DarkTheme : DefaultTheme}>
      ...
      >
        ...
        <Stack.Screen
          ...
          component={CleaningCategorySelectScreen}
        />
        ...
        <Stack.Screen
          name="SwachifyMarketScreen"
          component={SwachifyMarketScreen}
        />
        <Stack.Screen
